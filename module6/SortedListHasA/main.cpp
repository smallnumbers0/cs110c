...
int main()
{
   ...
   cout<< "Welcome to the tester!\nEnter high scores or a negative score to end: "<<endl;
   ...
   do {
      ...
      if(highScore >= 0) {
         intList->insertSorted(highScore);
      }
   } while (highScore>= 0);
   ...
   cout<<"Testing getPosition(6)"<<endl;
   cout<<intList->getPosition(6)<<endl;
